...
export default function Oauths() {
  ...
  return (
    <div className='login-group'>
      <button className='login login-facebook' onClick={loginToFacebook}><FontAwesomeIcon size='2x'
                                                                                          icon={faFacebookSquare} /><span>Login using Facebook</span>
      </button>
      <br />
      <button className='login login-twitter' onClick={loginToTwitter}><FontAwesomeIcon size='2x'
                                                                                        icon={faTwitterSquare} /><span>Login using Twitter</span>
      </button>
      <br />
      <button className='login login-google' onClick={loginToGoogle}><FontAwesomeIcon size='2x'
                                                                                      className='fa-google-color-new'
                                                                                      icon={faGoogle} /><span>Login using Google</span>
      </button>
      <br />
    </div>
  );
