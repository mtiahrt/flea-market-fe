...
import {
  ...
  ADD_ITEM_IMAGE,
  UPDATE_SALE_ITEM,
  GET_SALE_ITEM_AND_CATEGORIES, DELETE_INVENTORY_ITEM
...
const EditItem = () => {
    ...
    const [deleteInventory, { deletedData, deletedLoading, deletedError }] = useMutation(DELETE_INVENTORY_ITEM);
    ...
    return (
      <StyledForm onSubmit={handleSubmit(handleEditItemSubmit, onError)}>
        ...
        <StyledButtonDiv>
          ...
          <Button onClick={deleteInventoryItem} type='submit' color='error' variant='contained'>Delete</Button>
        </StyledButtonDiv>
      </StyledForm>
    );
  }
